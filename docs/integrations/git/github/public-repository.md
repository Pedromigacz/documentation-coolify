...
<ZoomableImage src="/docs/images/integrations/git/github/1.webp" />
...
<ZoomableImage src="/docs/images/integrations/git/github/2.webp" />
...
<ZoomableImage src="/docs/images/integrations/git/github/3.webp" />

Select the server where you want to deploy the application.


## 4. Enter Your Repository Link
<ZoomableImage src="/docs/images/integrations/git/github/4.webp" />
...
<ZoomableImage src="/docs/images/integrations/git/github/5.webp" />
