...
<ZoomableImage src="/docs/images/integrations/git/github/deploy-key/10.webp" />

Choose the server where you want to deploy the application.


## 7. Choose Your Deploy Key
<ZoomableImage src="/docs/images/integrations/git/github/deploy-key/11.webp" />
...
<ZoomableImage src="/docs/images/integrations/git/github/deploy-key/12.webp" />
